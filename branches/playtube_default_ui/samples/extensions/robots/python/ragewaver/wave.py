...
def ProcessWave(wavelet):
  ...
  for position in todo:
    ...
    inline_blip.append('Rate this video!')
...
if __name__ == '__main__':
  myRobot = robot.Robot('Rage Waver',
                        image_url='http://blogs.abc.net.au/.a/6a00e0097e4e6888330115714f2382970c-800wi') 
