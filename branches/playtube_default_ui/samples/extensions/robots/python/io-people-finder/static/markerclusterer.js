...
MarkerClusterer.prototype.calculator_ = function(markers, numStyles) {
  ...
  for (var i = 0; i < markers.length; i++) {
    count += markers[i].clusterCount || 1;
  }
  var dv = count;
  while (dv !== 0) {
...
Cluster.prototype.addMarker = function(marker) {
  ...
  if (this.markers_.length == 0) {
    ...
    var count = marker.clusterCount || "";
    //var iconUrl = "http://chart.apis.google.com/chart?cht=it&chs=32x32&chco=008eff,000000ff,ffffff01&chl=" + count + "&chx=000000,13&chf=bg,s,00000000&ext=.png";
    var iconUrl = "http://chart.apis.google.com/chart?cht=d&chdp=mapsapi&chl=pin'i\\'[" + count + "'-2'f\\hv'a\\]h\\]o\\008eff'fC\\000000'tC\\008eff'eC\\Lauto'f\\&ext=.png";
